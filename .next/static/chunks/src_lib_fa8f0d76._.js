...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyA7daVXpemKFoWf9DRYR_OOWlgn_7Fayz8"),
    authDomain: ("TURBOPACK compile-time value", "controle-comandas.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "controle-comandas"),
    storageBucket: ("TURBOPACK compile-time value", "controle-comandas.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "920958453456"),
    appId: ("TURBOPACK compile-time value", "1:920958453456:web:2593477e30b001aaec00d5")
};
...
const loginUser = async (email, password)=>{
    try {
        ...
        // Verificação simples de senha (em produção, use hash)
        if (userData.password === password) {
            return {
                ...
                role: userData.role,
                criadoEm: userData.criadoEm.toDate()
            };
        }
        return null;
    } catch (error) {
...
const criarUsuario = async (email, password, nome, role = 'user')=>{
    try {
        // Verificar se email já existe
        const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])('email', '==', email));
        const existingUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(q);
        ...
        const docRef = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users'), {
            ...
            role,
            ativo: true,
            criadoEm: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"].now()
        });
        return docRef.id;
    } catch (error) {
...
const atualizarStatusUsuario = async (userId, ativo)=>{
    try {
...
const atualizarSenhaUsuario = async (userId, novaSenha)=>{
    try {
        const userRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'users', userId);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])(userRef, {
            password: novaSenha
        }); // Em produção, use hash
    } catch (error) {
...
//# sourceMappingURL=src_lib_fa8f0d76._.js.map